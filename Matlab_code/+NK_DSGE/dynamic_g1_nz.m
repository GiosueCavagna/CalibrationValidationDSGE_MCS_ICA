...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_current(15,1)=5; nzij_current(15,2)=5;
  nzij_current(16,1)=3; nzij_current(16,2)=6;
  nzij_current(17,1)=6; nzij_current(17,2)=6;
  nzij_current(18,1)=7; nzij_current(18,2)=7;
  nzij_current(19,1)=9; nzij_current(19,2)=8;
  nzij_current(20,1)=10; nzij_current(20,2)=8;
  nzij_current(21,1)=8; nzij_current(21,2)=9;
  nzij_current(22,1)=9; nzij_current(22,2)=9;
  nzij_current(23,1)=10; nzij_current(23,2)=10;
  nzij_fwrd = zeros(5, 2, 'int32');
  nzij_fwrd(1,1)=1; nzij_fwrd(1,2)=1;
  nzij_fwrd(2,1)=1; nzij_fwrd(2,2)=2;
  nzij_fwrd(3,1)=2; nzij_fwrd(3,2)=2;
  nzij_fwrd(4,1)=7; nzij_fwrd(4,2)=2;
  nzij_fwrd(5,1)=1; nzij_fwrd(5,2)=4;
end
